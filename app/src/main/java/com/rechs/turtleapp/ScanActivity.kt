...
import kotlinx.android.synthetic.main.activity_scan_activity.scan_button
import kotlinx.android.synthetic.main.activity_scan_activity.scan_results_recycler_view
...
class ScanActivity : AppCompatActivity() {
    ...
    /**
     * Lambda function that controls BLE device
     */
        ...
        ConnectionEventListener().apply {
            onConnectionSetupComplete = { gatt ->
                Intent(this@ScanActivity, MainActivity::class.java).also {
                    ...
                    /**
                     * Added Code:
                     * Return Bluetooth device to ActivityResult
                     */
